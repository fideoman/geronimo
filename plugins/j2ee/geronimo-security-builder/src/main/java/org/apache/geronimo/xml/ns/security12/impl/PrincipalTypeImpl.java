 ...
 */
public class PrincipalTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.apache.geronimo.xml.ns.security12.PrincipalType
{
    private static final long serialVersionUID = 1L;
    
    public PrincipalTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName DESIGNATEDRUNAS$6 = 
    ...
    public boolean getDesignatedRunAs()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DESIGNATEDRUNAS$6);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(DESIGNATEDRUNAS$6);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetDesignatedRunAs()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(DESIGNATEDRUNAS$6);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(DESIGNATEDRUNAS$6);
            }
            return target;
        }
    }
    ...
    public boolean isSetDesignatedRunAs()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(DESIGNATEDRUNAS$6) != null;
        }
    }
    ...
    public void setDesignatedRunAs(boolean designatedRunAs)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DESIGNATEDRUNAS$6);
            }
    ...
    public void xsetDesignatedRunAs(org.apache.xmlbeans.XmlBoolean designatedRunAs)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(DESIGNATEDRUNAS$6);
            }
