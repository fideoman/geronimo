 ...
 */
public class GerOpenejbClusteringWadiTypeImpl extends org.apache.geronimo.xbeans.geronimo.j2ee.impl.GerAbstractClusteringTypeImpl implements org.apache.geronimo.xbeans.openejb.cluster.wadi.GerOpenejbClusteringWadiType
{
    private static final long serialVersionUID = 1L;
    
    public GerOpenejbClusteringWadiTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SWEEPINTERVAL$0 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "sweepInterval");
    private static final javax.xml.namespace.QName NUMPARTITIONS$2 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "numPartitions");
    private static final javax.xml.namespace.QName CLUSTER$4 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "cluster");
    private static final javax.xml.namespace.QName DISABLEREPLICATION$6 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "disableReplication");
    private static final javax.xml.namespace.QName DELTAREPLICATION$8 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "deltaReplication");
    private static final javax.xml.namespace.QName BACKINGSTRATEGYFACTORY$10 = 
        new javax.xml.namespace.QName("http://geronimo.apache.org/xml/ns/openejb-clustering-wadi-1.2", "backing-strategy-factory");
     ...
     */
    public org.apache.geronimo.xbeans.geronimo.naming.GerPatternType getCluster()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.geronimo.xbeans.geronimo.naming.GerPatternType target = null;
            target = (org.apache.geronimo.xbeans.geronimo.naming.GerPatternType)get_store().find_element_user(CLUSTER$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCluster(org.apache.geronimo.xbeans.geronimo.naming.GerPatternType cluster)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.geronimo.xbeans.geronimo.naming.GerPatternType)get_store().add_element_user(CLUSTER$4);
            }
            target.set(cluster);
        }
    }
     ...
     */
    public org.apache.geronimo.xbeans.geronimo.naming.GerPatternType addNewCluster()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.apache.geronimo.xbeans.geronimo.naming.GerPatternType getBackingStrategyFactory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.geronimo.xbeans.geronimo.naming.GerPatternType target = null;
            target = (org.apache.geronimo.xbeans.geronimo.naming.GerPatternType)get_store().find_element_user(BACKINGSTRATEGYFACTORY$10, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBackingStrategyFactory(org.apache.geronimo.xbeans.geronimo.naming.GerPatternType backingStrategyFactory)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.geronimo.xbeans.geronimo.naming.GerPatternType)get_store().add_element_user(BACKINGSTRATEGYFACTORY$10);
            }
     ...
     */
    public org.apache.geronimo.xbeans.geronimo.naming.GerPatternType addNewBackingStrategyFactory()
    {
        synchronized (monitor())
        {
            check_orphaned();
